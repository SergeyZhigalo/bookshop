<?php
    ...
    if ($result) {
        ...
        if ($table == '<table border = 1px><tr><td>id книги</td><td>название книги</td><td>автор книги</td><td>жанр книги</td><td>издатель книги</td><td>год издания</td><td>цена книги</td><td>обложка</td><td id="t1">✍</td></tr></table>') 
